...
export const allProducts: Product[] = [
  { slug: "fresh-okro", name: "Fresh Okro", price: 4.99, unit: "per lb", category: "fresh-produce", featured: true, image: "/images/okro.jpg", fallback: "https://placehold.co/400x300/png", description: "Farm-fresh okro, perfect for soups, stews, and traditional West African dishes. Hand-selected for quality and freshness.", metaTitle: "Fresh Okro - Adom African Market Minneapolis", metaDescription: "Buy fresh okro at Adom African Market in Minneapolis. Perfect for soups, stews, and traditional West African dishes. $4.99 per lb." },
